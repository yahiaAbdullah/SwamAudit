...
<div class="item item6 item7">
        <input class="form-control" type="search" placeholder="Search user">
        <a href="adduser.html" class="btn btn-success btn1">Add New</a>
        <a href="profile.html" class="btn btn-success btn1">Profile</a>
</div>
 <!--end  page header -->
</div>
<div class="row">
