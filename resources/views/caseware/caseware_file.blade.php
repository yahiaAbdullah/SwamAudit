...
<!--  page header -->
<div class="col-lg-12">
   <h1 class="page-header">CaseWare Files</h1>
</div>
<!-- end  page header -->
</div>
<div class="row">
...
<div  class="item">
   ...
   <label class="col-md-3" for="exampleInputFile">File:</label>
...
<div  class="item">
   <label class="col-md-2" style="    margin-top: 15px;">User:</label>
   <select>
...
<td>Nasir Co</td>
<td>Ali</td>
<td><a href=""><i class="fa fa-download ico" aria-hidden="true"></i></a></td>
          <td><a href=""><i class="fa fa-trash ico" aria-hidden="true"></i></a></td>
